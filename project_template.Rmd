...
As described in the first section, we want to use the open and closing time, coverage, and reason (with their respective subcategories, to draw a conclusion with the "Conclusion" variable.

###Open and Closing Time Compared
